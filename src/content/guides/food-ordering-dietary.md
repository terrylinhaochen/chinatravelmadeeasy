...
icon: "bowl"
faqs:
  - q: "How do I order at a Chinese restaurant with a QR-code menu?"
    a: "Scan the table's QR code with WeChat or Alipay (it opens a mini-program menu), add dishes to the cart, and pay in the same flow — food arrives at your table with no waiter interaction. If the menu defeats you, screenshot it and run image translation, or wave a waiter over and point at a picture menu."
  - q: "How do I explain a food allergy in China?"
  ...
  - q: "Is vegetarian or vegan food easy to find in China?"
    a: "Easier than the menus suggest. Vegetable and tofu dishes are everywhere, but watch for meat-based broths and lard; the phrase 我吃素 ('I eat vegetarian') plus 不要肉汤 ('no meat broth') covers most cases. Buddhist vegetarian restaurants (素食) near temples are fully plant-based and excellent."
  - q: "Can foreigners use Meituan or Ele.me food delivery?"
  ...
  - q: "Is street food in China safe to eat?"
    a: "Generally yes at busy stalls with high turnover — heat and crowds are your safety signals. Drink bottled or boiled water (tap water is not for drinking anywhere in China), be gentle with chili and lamb skewers on day one, and carry stomach meds as insurance."
---
...
3. Pay inside the same flow with your linked foreign card ([setup guide](/guides/alipay-wechat-pay-foreign-cards/)). Food simply appears.
...
| Character | Means | Watch for |
|---|---|---|
| 辣 | spicy | 微辣 mild / 中辣 medium / 特辣 regret |
| 牛 | beef | 牛肉面 = beef noodles |
| 猪 | pork | default meat if unspecified |
| 鸡 / 鸭 | chicken / duck | |
| 鱼 / 虾 | fish / shrimp | bones and shells often included |
| 羊 | lamb | skewers, hotpot |
| 素 | vegetarian | 素菜 = veggie dishes section |
| 面 / 饭 | noodles / rice | the carb axis of every menu |
| 汤 | soup | broths are usually meat-based |
