...
export const PUBLISHED_DESTINATION_SLUGS = ['hong-kong', 'shanghai', 'beijing', 'tianjin', 'chongqing', 'chengdu', 'xian', 'guangzhou', 'shenzhen', 'hangzhou', 'kunming', 'dali', 'lijiang', 'guilin', 'yangshuo', 'zhangjiajie', 'suzhou', 'nanjing', 'wuhan', 'xiamen', 'fuzhou', 'quanzhou', 'changsha', 'qingdao', 'taiyuan', 'datong', 'pingyao', 'macau'];
